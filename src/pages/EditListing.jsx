...
function EditListing() {
  ...
  // Get the listing and add the data to the form to be changed
  useEffect(() => {
    setLoading(true);
    const fetchListing = async () => {
      ...
      if (docSnap.exists()) {
        ...
        // Fill in the form data with the listing info
        setFormData({
          ...docSnap.data(),
  ...
  // If logged in user doesn't own the listing, redirect
  useEffect(() => {
    if (listing && listing.userRef !== auth.currentUser.uid) {
      toast.error('Current user cannot edit this listing');
      navigate('/');
    }
  });
